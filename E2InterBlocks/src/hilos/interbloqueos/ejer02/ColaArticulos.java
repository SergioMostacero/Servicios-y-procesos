...
class Productor implements Runnable {
    ...
    @Override
    public void run() {
    	ColaArticulos primera,segunda;
    	
    	if(System.identityHashCode(colaPendientes)<System.identityHashCode(colaRevisados)) {
    		primera=colaPendientes;
    		segunda=colaRevisados;
    	}else {
    		primera=colaRevisados;
    		segunda=colaPendientes;
    	}
